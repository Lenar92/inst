...
// абстракция - выкидываем все лишнее, что не нужно для решения
...
const photo = {
    ...
    videoUrl: null, // специальный маркер, который сообщает что значения нет
    likes: 159594,
};

// underfiend и null можно записать куда угодно

//пост с видео
const video = {
    id: 'B24F82NooNX'
    author: author,
    location: Торгово-развлекательный Центр Острова'
    imageUrl; 'https://placekitten.com/800/800',
